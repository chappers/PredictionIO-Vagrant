...
if [ ! -f $INSTALLED_FLAG ]; then
  ...
  bash -e -c "$(curl -s https://gist.githubusercontent.com/chappers/1a8844ab6d9e216b0b0bdd84def683bf/raw/5944a14a6ba6bef805e33973041f40af201b563c/install.sh)" 0 -y
